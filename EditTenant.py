...
# Edit Tenat label
edit_label=tk.Label(add_frame,text="Edit Tenant",bg='white',font=('times new roman',25,'bold'))
edit_label.pack()
...
# Edit Tenant frame
editTenant_frame = tk.Frame(det_frame, bg="white")
editTenant_frame.place(x=945,y=590)

editTenant = tk.Button(editTenant_frame,text="Save",font=("times new roman",14,"bold"), pady= 5, padx= 15,background= "#2C6FBC",width=10)
editTenant.pack()
