...
# Edit Rental label
editRental_label=tk.Label(add_frame,text="Edit Rental",bg='white',font=('times new roman',25,'bold'))
editRental_label.pack()
...
resized = zip_pic.resize((110,35),Image.Resampling.LANCZOS)
...
# Edit Rental frame
edit_frame = tk.Frame(det_frame, bg="white")
edit_frame.place(x=945,y=590)

editRental = tk.Button(edit_frame,text="Save",font=("times new roman",14,"bold"), pady= 5, padx= 15,background= "#2C6FBC",width=10)
editRental.pack()
